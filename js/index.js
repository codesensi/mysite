parcelRequire = function (e, r, t, n) {
    ...
    "XR92": [function (require, module, exports) {
        ...
        !function (e, n) {
            ...
            var e, n = function () {
                var e, n, r, i, o, a, s = [], u = s.concat, c = s.filter, l = s.slice, f = t.document, h = {}, p = {},
                    d = {
                        "column-count": 1,
                        columns: 1,
                        "font-weight": 1,
                    ...
                    y = /^(?:body|html)$/i, x = /([A-Z])/g,
                    b = ["val", "css", "html", "text", "data", "width", "height", "offset"],
                    E = f.createElement("table"), j = f.createElement("tr"), T = {
                        ...
                        th: j,
                        "*": f.createElement("div")
                    }, w = /complete|loaded|interactive/, S = /^[\w-]*$/, C = {}, N = C.toString, O = {},
                    P = f.createElement("div"), A = {
                        tabindex: "tabIndex",
                        readonly: "readOnly",
                        for: "htmlFor",
                        class: "className",
                ...
                return O.matches = function (t, e) {
                    ...
                    var i, o;
                    if (!t) return O.Z();
                    if ("string" == typeof t) if ("<" == (t = t.trim())[0] && m.test(t)) i = O.fragment(t, RegExp.$1, n), t = null; else {
                        ...
                        if (D(t)) o = t, i = c.call(o, function (t) {
                            return null != t
                        }); else if (M(t)) i = [t], t = null; else if (m.test(t)) i = O.fragment(t.trim(), RegExp.$1, n), t = null; else {
                            if (n !== e) return r(n).find(t);
                            i = O.qsa(f, t)
                        }
                    }
                    ...
                    var n, i, o, a, s = [];
                    if (Z(t)) for (i = 0; i < t.length; i++) null != (n = e(t[i], i)) && s.push(n); else for (o in t) null != (n = e(t[o], o)) && s.push(n);
                    ...
                    wrapAll: function (t) {
                        if (this[0]) {
                            var e;
                            for (r(this[0]).before(t = r(t)); (e = t.children()).length;) t = e.first();
                            r(t).append(this)
                        }
                        return this
                    },
                    wrapInner: function (t) {
                        ...
                        return this.each(function (n) {
                            var i = r(this), o = i.contents(), a = e ? t.call(this, n) : t;
                    ...
                    attr: function (t, r) {
                        ...
                        return "string" != typeof t || 1 in arguments ? this.each(function (e) {
                            if (1 === this.nodeType) if (M(t)) for (n in t) U(this, n, t[n]); else U(this, t, B(this, r, e, this.getAttribute(t)))
                    ...
                    offset: function (e) {
                        if (e) return this.each(function (t) {
                            var n = r(this), i = B(this, e, t, n.offset()), o = n.offsetParent().offset(),
                    ...
                    position: function () {
                        if (this.length) {
                            var t = this[0], e = this.offsetParent(), n = this.offset(),
                                i = y.test(e[0].nodeName) ? {top: 0, left: 0} : e.offset();
                    ...
                    r.fn[n] = function () {
                        ...
                        return s.length < 1 ? this : this.each(function (e, n) {
                            ...
                            s.forEach(function (e) {
                                ...
                                a.insertBefore(e, n), c && function t(e, n) {
                                    n(e);
            ...
            return t.Zepto = n, void 0 === t.$ && (t.$ = n), function (e) {
                var n, r = 1, i = Array.prototype.slice, o = e.isFunction, a = function (t) {
                    ...
                    }, s = {}, u = {}, c = "onfocusin" in t, l = {focus: "focusin", blur: "focusout"},
                ...
                var x = function () {
                    ...
                    return !1
                }, E = /^([A-Z]|returnValue$|layer[XY]$|webkitMovement[XY]$)/, j = {
                ...
                var n, r, i = +new Date, o = t.document, a = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,
                    s = /^(?:text|application)\/javascript/i, u = /^(?:text|application)\/xml/i, c = "application/json",
                    l = "text/html", f = /^\s*$/, h = o.createElement("a");
                ...
                h.href = t.location.href, e.active = 0, e.ajaxJSONP = function (n, r) {
                    ...
                    var a, s, u = n.jsonpCallback, c = (e.isFunction(u) ? u() : u) || "Zepto" + i++,
                        l = o.createElement("script"), f = t[c], h = function (t) {
                    ...
                    var w, S = b.accepts[j], C = {}, N = function (t, e) {
                            C[t.toLowerCase()] = [t, e]
                        }, O = /^([\w-]+:)\/\//.test(b.url) ? RegExp.$1 : t.location.protocol, P = b.xhr(),
                    ...
                    if (P.setRequestHeader = N, P.onreadystatechange = function () {
                        if (4 == P.readyState) {
                            ...
                            if (P.status >= 200 && P.status < 300 || 304 == P.status || 0 == P.status && "file:" == O) {
                                if (j = j || ((r = b.mimeType || P.getResponseHeader("content-type")) && (r = r.split(";", 2)[0]), r && (r == l ? "html" : r == c ? "json" : s.test(r) ? "script" : u.test(r) && "xml") || "text"), "arraybuffer" == P.responseType || "blob" == P.responseType) t = P.response; else {
                                    t = P.responseText;
                                    try {
                                        t = function (t, e, n) {
        ...
        function e() {
            var e = [
                ...
                "平凡的日常正奇迹的发生着",
                "你可以不同意我的观点但我可以打你",
                "今朝有酒今朝醉<br>tomorrow is another day",
                "敬畏之心",
                "只要我没有道德<br>你就绑架不了我",
                "成功就是1%的灵感加上99%的远离手机",
                "赞美之心",
                ".早上早早起来真的可以做很多事<br>比如再睡一觉",
                "随风奔跑自由是方向<br>无奈忘了腿短没力量",
                "仁爱之心",
                "想到明天还有很多事做<br>我直接睡到后天",
                "人还是要多出去走走<br>不然根本不知道在家玩手机有多舒服",
                "宽容之心",
                "别觉得自己差<br>你还有很大的退步空间",
                "舒缓的现代音乐",
                "我总告诉自己<br>你长得好看了不起啊",
                "岁月不饶人<br>我亦未曾饶过岁月",
                "你身上有她的香水味<br>一闻就没我的贵",
                "我叫了300多个兄弟你说砍谁就砍谁<br>结果你让我砍拼多多？",
                "东边日出西边雨<br>你爷我是大美女"
            ],
            i = o(0, e.length - 1);
            t("#slogan").html(e[i])
        ...
        delete Object.prototype.document, delete Object.prototype.location, window.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
            ...
            var a = i.getContext("2d"), r = o.getContext("2d"), l = t, d = [], c = 0;
